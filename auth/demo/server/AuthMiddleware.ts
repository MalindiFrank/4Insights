...
export class AuthMiddleware {
   ...
   */
  async requireAuth(req: Request): Promise<{ apiKey: string | null; error?: string }> {
   ...
   */
  static createErrorResponse(message: string, statusCode: number = 400): Response {
   ...
   */
  static createSuccessResponse(data: unknown, message: string = 'Success', statusCode: number = 200): Response {
    const response: AuthResponse = {
      success: true,
      message,
      data
